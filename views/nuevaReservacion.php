		...
		<div class="row" id="opt-gen-res">
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="row x_panel">
					...
					<hr>					
					<select class="form-control" name="select-tipo-reservacion" id="select-tipo-reservacion">
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				<div class="row">
					...
					<div class="col-md-6">
						<a class="btn btn-success btn-lg" id="btn-recalcular">Actualizar</a>
					</div>
				</div>
				<hr />
				<div class="row">
					<div class="col-md-6">
						<a class="btn btn-warning btn-lg" id="btn-guardar">Guardar</a>
					</div>
					<div class="col-md-6">
